function ImagePopup(props) {
  ...
  return (
    <div className={`popup popup_type_img ${props.card.isOpen ? 'popup_visible': ' '} `}>
      <div
      ...
      >
        ...
        ></button>
        <img className="popup__picture" src={`${props.card.linkCard.linkCard}`} alt={`${props.card.nameCard.nameCard}`} />
